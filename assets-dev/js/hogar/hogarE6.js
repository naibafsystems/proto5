$(function () {
    ...
    $('input[type=radio][name=abandono_forzado]').on('change', function() {
        if($(this).val() == 1) {
            $('#abandono_forzado-1-panel').removeClass('hidden');
        } else {
            $('#abandono_forzado-1-panel').addClass('hidden');
            $('#anios_abandono').val('');
            $('input[name=retorno_abandono]').prop('checked', false);
        }
    });
    ...
    $('#frmHogar').validate({
        ...
        rules: {
            abandono_forzado: { required: true },
            anios_abandono: { required: true },
            retorno_abandono: { required: true }
        },
        messages: {
            abandono_forzado: { required: 'Debes seleccionar una de las opciones del hogar.' },
            anios_abandono: { required: 'Debes seleccionar una de las opciones del hogar.' },
            retorno_abandono: { required: 'Debes seleccionar una de las opciones del hogar.' }
        },
        /*acc*/
