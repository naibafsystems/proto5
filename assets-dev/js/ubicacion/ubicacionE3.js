$(function () {
    ...
    $('#frmUbicacion').validate({
        ...
        messages: {
            tipo_lugar: {required: 'ERROR: Seleccione el tipo del lugar.' },
            nombre_lugar: {
                required: 'ERROR: Digite el nombre de Barrio, Corregimiento, Vereda, Ranchería o Comunidad.',
                minlength: 'ERROR: El nombre del Barrio, Corregimiento, Vereda, Ranchería o Comunidad debe ser de mínimo 5 caracteres.',
            }
        },
        /*acc*/
