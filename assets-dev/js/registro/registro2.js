$(function () {
    ...
    $('#primer_nombre').soloNombre().maxlength(30).convertirTildes().convertirMayuscula().verificaEspacios();
    $('#segundo_nombre').soloNombre().maxlength(30).convertirTildes().convertirMayuscula().verificaEspacios();
    $('#primer_apellido').soloNombre().maxlength(30).convertirTildes().convertirMayuscula().verificaEspacios();
    $('#segundo_apellido').soloNombre().maxlength(30).convertirTildes().convertirMayuscula().verificaEspacios();
    ...
    $('#frmRegistro').validate({
        ...
        messages: {
            primer_nombre: {required: 'ERROR: Digite el primer nombre de la persona.'},
            primer_apellido: {required: 'ERROR: Digite el primer apellido de la persona.'}
        },
        /*acc*/
