$(function () {
    ...
    $('#frmPersona').validate({
        ...
        rules: {
            limitacion_caminar: {required: true}
        },
        messages: {
            limitacion_caminar: {required: 'ERROR: Debe seleccionar si la persona tiene dificultad para mover el cuerpo, caminar o subir y bajar escaleras.'}
        },
        /*acc*/
