$(function () {
    ...
    $('#frmPersona').validate({
        ...
        rules: {
            ayuda_tecnica: {required: true},
            ayuda_personas: {required: true},
            ayuda_medicamentos: {required: true},
            ayuda_practicas: {required: true}
        },
        messages: {
            ayuda_tecnica: {required: 'ERROR: Debe seleccionar si la persona utiliza ayudas permanentes técnicas o tecnológicas.'},
            ayuda_personas: {required: 'ERROR: Debe seleccionar si la persona utiliza ayudas permanentes de otras personas.'},
            ayuda_medicamentos: {required: 'ERROR: Debe seleccionar si la persona utiliza ayudas permanentes de medicamentos o terapias.'},
            ayuda_practicas: {required: 'ERROR: Debe seleccionar si la persona utiliza ayudas permanentes de prácticas de medicina ancestral.'}
        },
        /*acc*/
