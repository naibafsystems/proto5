$(function () {
    ...
    $('#frmPersona').validate({
        ...
        rules: {
            limitacion_tareas: {required: true}
        },
        messages: {
            limitacion_tareas: {required: 'ERROR: Debe seleccionar si la persona tiene dificultad para hacer las tareas diarias sin mostrar problemas cardiacos, respiratorios.'}
        },
        /*acc*/
