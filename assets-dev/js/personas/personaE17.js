$(function () {
    ...
    $('#frmPersona').validate({
        ...
        rules: {
            limitacion_relacion: {required: true}
        },
        messages: {
            limitacion_relacion: {required: 'ERROR: Debe seleccionar si la persona tiene dificultad para relacionarse o interactuar con las demás personas.'}
        },
        /*acc*/
