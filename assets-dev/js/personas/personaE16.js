$(function () {
    ...
    $('#frmPersona').validate({
        ...
        rules: {
            limitacion_comer: {required: true}
        },
        messages: {
            limitacion_comer: {required: 'ERROR: Debe seleccionar si la persona tiene dificultad para comer, vestirse o bañarse por sí mismo(a).'}
        },
        /*acc*/
