$(function () {
    ...
    $('#frmPersona').validate({
        ...
        rules: {
            limitacion_coger: {required: true}
        },
        messages: {
            limitacion_coger: {required: 'ERROR: Debe seleccionar si la persona tiene dificultad para agarrar o mover objetos con las manos.'}
        },
        /*acc*/
