$(function () {
    ...
    $('#frmPersona').validate({
        ...
        rules: {
            limitacion_decidir: {required: true}
        },
        messages: {
            limitacion_decidir: {required: 'ERROR: Debe seleccionar si la persona tiene dificultad para entender, aprender, recordar o tomar decisiones por sí mismo(a).'}
        },
        /*acc*/
