        ...
        <form id="frmUbicacionN" name="frmUbicacionN" role="form" method="post" action="<?php echo base_url('ubicacion/guardarUbicacion') ?>">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4">                        
                        ...
                        <input type="number" name="ub1_codigo_depto" id="ub1_codigo_depto" size="10" max="99" min="1" value="<?php echo $respuestas[0]["U_DPTO"]; ?>">
                    </div>
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4">                        
                        <label>C&oacute;digo </label>
                        <input type="number" name="ub1_codigo_mun" id="ub1_codigo_mun" size="10" max="99999" min="1" value="<?php echo $respuestas[0]["U_MPIO"]; ?>">
                    </div>                    
                </div>
            </div>
            <div class="row">
                    ...
                    <fieldset>
                        <div class="col-xs-12 col-sm-12 col-md-12">                        
                            ...
                            <fieldset>
                                ...
                                <div class="col-xs-4 col-sm-4 col-md-4">                        
                                    <label>C&oacute;digo</label>
                                    <input type="number" name="ub4_codigo_area_protegida" id="ub4_codigo_area_protegida" size="10" max="9999" min="1"  value="<?php echo $respuestas[0]["UVA1_COD_AREAPROT"]; ?>">                        
                                </div>
                            </fieldset>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">                        
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">                        
                        <input type="number" name="ub5_area_coordinacion_operativa" id="ub5_area_coordinacion_operativa" max="999" value="<?php echo $respuestas[0]["U_CO"]; ?>">
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">                         
                        <label>&Aacute;rea operativa</label>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">                        
                        <input type="number" name="ub5_area_operativa"  max="999999" id="ub5_area_operativa" value="<?php echo $respuestas[0]["U_AO"]; ?>">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">                        
                        <input type="number" name="ub6_codigo_unidad_cobertura" id="ub6_codigo_unidad_cobertura_urbana" max="999999" value="<?php echo $respuestas[0]["U_UC"]; ?>">
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">                        
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">                        
                        <input type="number" name="ub6_codigo_unidad_cobertura" id="ub6_codigo_unidad_cobertura_rural" max="999999" value="<?php echo $respuestas[0]["U_UC"]; ?>"> 
                    </div>                                       
                </div>
            </div>
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">                        
                        <input type="number" name="ub7_numero_edificacion" id="ub7_numero_edificacion" max="999" value="<?php echo $respuestas[0]["U_EDIFICA"]; ?>">
                    </div>                                      
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">                        
                        <input type="number" name="ub10_numero_orden" id="ub10_numero_orden" max="999" value="<?php echo $respuestas[0]["U_VIVIENDA"]; ?>">
                    </div>                                      
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <fieldset>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">                        
                            <input type="radio" name="ub13_territorio" value="2" <?php if( $respuestas[0]["UVA_VIVTERETNICO"]==2 ) { ?>checked="checked"<?php } ?>>
                            <label for="2">No</label>
                        </div>
                    </fieldset>
                </div>
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4">                       
                        <input type="number" name="vv16_total_hogares" max="99" id="vv16_total_hogares" value="<?php echo $respuestas[0]["V_TOT_HOG"]; ?>">
                    </div>                   
                </div>
            </div>
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4">                        
                        ...
                        <fieldset>
                            ...
                            <div class="col-xs-11 col-sm-11 col-md-11">                        
                                <label>Estrato</label>
                                <input type="text" name="vv19_estrato_energia_electrica" id="vv19_estrato_energia_electrica" max="9" value="<?php echo $respuestas[0]["VA1_ESTRATO"]; ?>">
                            </div>
                        </fieldset>                          
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4">                        
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4">                        
                        ...
                        <fieldset>
                            ...
                            <div class="col-xs-11 col-sm-11 col-md-11">                        
                                ...
                                <input type="text" name="vv19_basura_veces" id="vv19_basura_veces" max="9" value="<?php echo $respuestas[0]["VE1_QSEM"]; ?>">
                            </div>
                        </fieldset>                          
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4">                        
