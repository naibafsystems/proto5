    ...
    <div id="divForm" class="col-xs-12 col-sm-12 col-md-12">
        <form id="frmUbicacion" name="frmUbicacion" role="form" method="post">
            <?php foreach ($var as $k => $v) { ?>
                <?php if($v['ID_PREGUNTA'] == 'direccion_clase2') { ?>
                    <div id="plantilla_complemento" class="hidden">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div id="otro_comple-col" class="col-xs-12 col-sm-12 col-md-offset-3 col-md-6">
                        ...
                        <div id="divComple0">
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-xs-2 col-sm-2 col-md-offset-3 col-md-2">
                                        <label class="control-label">Complemento</label>
                                        <select name="complemento0" data-field="complemento" class="form-control adicionarComple" autocomplete="off">
                                            <option value="">Ejemplo: Manzana</option>
                                            <?php
                                            foreach ($arrComplemento as $data):
                                                echo "<option value='" . $data['ID_VALOR'] . "'>" . $data['ETIQUETA'] . "</option>";
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-4">
                                        <label class="control-label">Adición</label>
                                        <input type="text" name="adicion0" data-field="adicion" class="form-control adicionarComple"  placeholder="Ejemplo 26A" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
                                    <div id="otro_comple-col" class="col-xs-12 col-sm-12 col-md-offset-3 col-md-6">
                                        <label id="otro_comple-lbl" class="control-label" for="otro_comple0">¿Agregar otro complemento?</label>
                                        <div class="radio" id="radio_otro_comple_1">
                                            <label><input name="otro_comple0" id="otro_comple_1" value="1" class="otro_comple" aria-describedby="acc_ayuda_1" type="radio"> Sí</label>
                                        </div>
                                        <div class="radio" id="radio_otro_comple1_2">
                                            <label><input name="otro_comple0" id="otro_comple_2" value="2" aria-describedby="acc_ayuda_2" type="radio"> No</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
