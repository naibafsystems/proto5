...
<div class="row">
    <div class="col-md-12 text-center">
        <h3>Búsqueda de usuarios que acceden a diligenciar eCenso</h3>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-md-12">
        <table id="tablaUsuarios" class="table table-bordered table-striped table-hover" data-role="datatable" data-info="false" width="100%" cellspacing="0">
            <thead>
                <tr class="success">
                    <th>Usuario (email)</th>
                    <th>Número docu.</th>
